        ...
        obj.updatePagination = function() {
            ...
            if (obj.options.pagination) {
                ...
                if (! results) {
                    ...
                    var lastInfo = (obj.pageNumber + 2)*obj.options.pagination;
                    lastInfo = (lastInfo<results)?lastInfo:results;
                    obj.pagination.children[0].innerHTML = format(obj.options.text.showingPage,
                        (obj.pageNumber)*obj.options.pagination + 1, lastInfo, results)
                }
            }
        }
